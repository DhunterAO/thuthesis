...
近年来，用户数据逐渐集中存储在各大互联网公司的数据库中。用户希望能充分利用这些数据满足自身需求，为了缓解对公司自有解决方案的依赖，近年来出现了第三方独立服务提供商。第三方服务提供商通过获取用户授权，从大型公司的数据库中获取用户数据，为用户提供更丰富、灵活的服务。为了帮助大型公司管理第三方服务提供商对用户数据的访问，OAuth及类似的第三方授权框架被提出，
